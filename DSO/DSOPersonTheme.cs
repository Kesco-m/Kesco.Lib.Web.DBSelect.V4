...
namespace Kesco.Lib.Web.DBSelect.V4.DSO
{
    ...
    public class DSOPersonTheme : DSOCommon
    {
        ...
        /// </summary>
        [FilterOption("Каталог", false, "CatId")]
        public FOptCatalog Catalog;

        /// <summary>
        ///     Опция фильтра по наименованию темы лица
        /// </summary>
        [FilterOption("ТемаЛица", false, "Search")]
        public FOptPersonTheme Name;
        ...
        /// </summary>
        public override string SQLBatch => SQLQueries.SELECT_ТемыЛиц;
