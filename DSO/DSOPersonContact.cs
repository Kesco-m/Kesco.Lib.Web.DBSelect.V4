...
using Kesco.Lib.Web.DBSelect.V4.DSO.FOpt.PersonContact;
...
namespace Kesco.Lib.Web.DBSelect.V4.DSO
{
    ...
    public class DSOPersonContact : DSOCommon
    {
        ...
        ///     Опция фильтра по ID
        /// </summary>
        [FilterOption("КодКонтакта")] public FOptIDs ContactId;

        /// <summary>
        ///     Опция фильтра по типу контакта
        /// </summary>
        [FilterOption("КодТипаКонтакта")] public FOptIDs ContactTypeId;

        /// <summary>
        ///     Опция фильтра по имени
        /// </summary>
        [FilterOption("Контакт")] public FOptName Name;
        ...
        /// </summary>
        [FilterOption("Действует")] public FOptValidAt ValidAt;
        ...
        public override string SQLBatch
        {
            get
            {
                if (null == PersonId || PersonId.CompanyHowSearch != "2" && PersonId.CompanyHowSearch != "3" &&
                    string.IsNullOrEmpty(PersonId.Value))
        ...
        /// </summary>
        public override string SQLOrderBy => "Контакт";
    }
}